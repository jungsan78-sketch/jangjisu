...
export default function ScheduleCalendarDashboard() {
  ...
  return (
    <div className="sou-calendar-dashboard w-full max-w-none rounded-[28px] bg-white/[0.025] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.035),0_24px_70px_rgba(0,0,0,0.22)] sm:rounded-[32px] sm:p-5 lg:p-7">
      <header className="sou-calendar-header mb-5 rounded-[26px] bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.12),transparent_34%),linear-gradient(180deg,#081525,#06101d)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.045),0_20px_48px_rgba(0,0,0,0.24)] sm:p-7">
