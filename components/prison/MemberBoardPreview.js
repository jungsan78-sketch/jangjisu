...
function LiveHoverCard({ member, status, large = false }) {
  ...
  return (
    <div className={`pointer-events-none absolute left-1/2 z-20 hidden -translate-x-1/2 overflow-hidden rounded-[20px] border border-rose-300/20 bg-[linear-gradient(180deg,rgba(12,18,31,0.98),rgba(5,10,18,0.98))] shadow-[0_24px_60px_rgba(0,0,0,0.38)] group-hover:block ${large ? 'bottom-[calc(100%+14px)] w-[260px]' : 'bottom-[calc(100%+12px)] w-[220px]'}`}>
