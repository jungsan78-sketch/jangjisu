...
export const PRISON_MANUAL_SCHEDULES = {
  ...
  honoe1330: {
    ...
    items: [
      ...
      makeItem(2026, 8, 4, '09:00 방송'),
      makeItem(2026, 8, 5, '09:00 방송(즐찾 이벤트 추첨) / 19:00 촉슈 입고 리듬게임(업보)'),
      makeItem(2026, 8, 6, '09:00 방송'),
      makeItem(2026, 8, 7, '09:00 방송(리캠 추첨) / 별도소 입주(미정)'),
      makeItem(2026, 8, 8, '09:00 방송'),
      makeItem(2026, 8, 9, '휴방'),
    ],
  },
  ximong: {
    member: '시몽',
    items: [
      ...
      makeItem(2026, 8, 4, '12:00 장지수용소 vs 어인섬 오프닝무대'),
      makeItem(2026, 8, 5, '17:00 두둥투어'),
      makeItem(2026, 8, 6, '휴방'),
      makeItem(2026, 8, 7, '휴방'),
      makeItem(2026, 8, 8, '17:00 두둥투어'),
      makeItem(2026, 8, 9, '13:00 짤방(목관리)'),
      makeItem(2026, 8, 10, '16:00 말티즈 쇼케이스(난초방송)'),
    ],
  },
};
