...
export const PRISON_MANUAL_SCHEDULES = {
  ...
  ximong: {
    ...
    items: [
      ...
      makeItem(2026, 8, 31, '구월이 펜션 놀러가기'),
      makeItem(2026, 9, 1, '20:00 여행 다녀온 거라 피곤 짧뱅'),
      makeItem(2026, 9, 2, '말티즈 48시간 의리노방종'),
      makeItem(2026, 9, 3, '치과'),
      makeItem(2026, 9, 4, '19:00 종겜 (시몽데이)'),
      makeItem(2026, 9, 5, '15:00 주말뱅'),
      makeItem(2026, 9, 6, '14:00 주말뱅'),
    ],
  },
};
