...
export default function OverwatchRandomPage() {
  ...
  const handleShuffle = () => {
    ...
    const pools = { tank: shuffleArray(groupedAll.tank), dps: shuffleArray(groupedAll.dps), support: shuffleArray(groupedAll.support), random: shuffleArray(groupedAll.random) };
