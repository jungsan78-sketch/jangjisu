...
function EmptySlot({ role, onDrop, active }) {
  ...
  return (
    <div onDragOver={(e) => e.preventDefault()} onDrop={onDrop} className={`flex w-[112px] min-h-[122px] flex-col items-center justify-center rounded-[22px] border ${active ? 'border-cyan-300/38 bg-cyan-300/10' : 'border-white/8 bg-white/[0.022]'} transition`}>
