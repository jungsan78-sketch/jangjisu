...
const CREW_GROUPS = [
  {
    ...
    count: 8,
    accent: 'cyan',
    members: ['감스트', '혜리', '유설아', '유연서', '망고랑', '니니', '앨리스암', '킴나니'],
  },
  {
    name: '홍신소',
    count: 15,
    accent: 'rose',
    members: ['홍타쿠', '장결', '따소히', '고체리', '모아', '야농', '조아썻', '라율', '휘비', '하비', '또야옹', '왜나니', '의깨굴', '현단아', '연아리'],
  },
  {
    name: '지력사무소',
    count: 13,
    accent: 'amber',
    members: ['지피티', '라무', '모나양', '싱유', '물초코', '니니밍', '김병살', '한아련', '김퀴카', '목추리', '메루', '나옹', '린코'],
  },
  {
    name: '가무소',
    count: 15,
    accent: 'violet',
    members: ['가습기', '하티하터', '쩜도은', '하루아이', '젤율이', '기찬하', '단수아', '아뽀', '당곰', '라초', '연보라', '토쿠', '연치민', '정다니', '퍼너'],
  },
  {
    name: '꾸한성',
    count: 16,
    accent: 'emerald',
    members: ['꾸꾸까까', '애교용', '하은비', '오렌지', '푸른별', '도아린', '밤비', '마이카', '유호', '세리나', '도리', '라니', '체르', '솜비', '유닝', '코유'],
  },
  {
    name: '그린캠프',
    count: 15,
    accent: 'sky',
    members: ['굿바이', '헤른', '리엔', '도로시', '벨라', '카요', '노아', '유메', '하린', '리아', '루체', '연비', '하나', '다온', '린비'],
  },
];

const CREW_THEME = {
  cyan: {
    card: 'border-cyan-300/24 bg-[linear-gradient(180deg,rgba(10,27,46,0.96),rgba(8,11,18,0.98))]',
    title: 'text-cyan-100',
    badge: 'border-cyan-300/24 bg-cyan-300/12 text-cyan-100',
    member: 'border-cyan-300/18 bg-cyan-300/10 text-cyan-50',
  },
  rose: {
    card: 'border-rose-300/24 bg-[linear-gradient(180deg,rgba(48,20,34,0.96),rgba(14,10,16,0.98))]',
    title: 'text-rose-100',
    badge: 'border-rose-300/24 bg-rose-300/12 text-rose-100',
    member: 'border-rose-300/18 bg-rose-300/10 text-rose-50',
  },
  amber: {
    card: 'border-amber-300/24 bg-[linear-gradient(180deg,rgba(52,34,14,0.96),rgba(15,11,8,0.98))]',
    title: 'text-amber-100',
    badge: 'border-amber-300/24 bg-amber-300/12 text-amber-100',
    member: 'border-amber-300/18 bg-amber-300/10 text-amber-50',
  },
  violet: {
    card: 'border-violet-300/24 bg-[linear-gradient(180deg,rgba(34,20,49,0.96),rgba(11,10,19,0.98))]',
    title: 'text-violet-100',
    badge: 'border-violet-300/24 bg-violet-300/12 text-violet-100',
    member: 'border-violet-300/18 bg-violet-300/10 text-violet-50',
  },
  emerald: {
    card: 'border-emerald-300/24 bg-[linear-gradient(180deg,rgba(18,38,28,0.96),rgba(8,12,11,0.98))]',
    title: 'text-emerald-100',
    badge: 'border-emerald-300/24 bg-emerald-300/12 text-emerald-100',
    member: 'border-emerald-300/18 bg-emerald-300/10 text-emerald-50',
  },
  sky: {
    card: 'border-sky-300/24 bg-[linear-gradient(180deg,rgba(14,28,52,0.96),rgba(8,10,18,0.98))]',
    title: 'text-sky-100',
    badge: 'border-sky-300/24 bg-sky-300/12 text-sky-100',
    member: 'border-sky-300/18 bg-sky-300/10 text-sky-50',
  },
};
    ...
    <section className={`rounded-[28px] border p-5 shadow-[0_16px_36px_rgba(0,0,0,0.22)] ${theme.card}`}>
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-white/56">시트 기반 카드 레이아웃 1차 프리뷰</p>
        </div>
...
export default function SoopCrewsPage() {
  return (
    <>
      <Head>
        <title>종겜 크루 목록 | 장지수 팬 아카이브</title>
        <meta name="description" content="종겜 크루 목록 독립 페이지 프리뷰" />
      </Head>
