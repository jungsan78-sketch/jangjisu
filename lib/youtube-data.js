...
export const YOUTUBE_DIRECT_MARKER = 'test2-youtube-lib-direct-20260427-1';
...
export async function fetchMainYoutubePayload(options = {}) {
  ...
  return {
    ...
    ...(debug ? { debug: { runtimeMarker: YOUTUBE_DIRECT_MARKER, runtimeEnvChecked: true, sourceMode: 'youtube_data_api_uploads_only', mainIds: mainIds.slice(0, 20), fullIds: fullIds.slice(0, 20), counts: { videos: videos.length, shorts: shorts.length, full: full.length } } } : {}),
  };
}
