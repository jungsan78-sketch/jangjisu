const FREE_PASS_GROUPS = [
  ...
  },
  {
    key: 'prison',
    label: '수용소',
    ids: ['iamquaddurup', 'doodong', 'ximong', 'kakazzang', 'sunza1122', 'isq1158', 'mini1212', 'youoneul', 'habbang2', 'hey092130', 'lilgochun', '8bibian8', 'amanemay', 'honoe1330'],
    nicknames: ['장지수', '냥냥두둥', '시몽', '후룽카카', '포포', '구월이', '린링', '유오늘', '하빵', '히루룽', '고춘자', '비비안', '김메이', '이치유'],
  },
  {
    key: 'musu',
    label: '무수',
