const FREE_PASS_GROUPS = [
  ...
  },
  {
    key: 'prison',
    label: '수용소',
    ids: ['iamquaddurup', 'doodong', 'lomioeov', 'ximong', 'youoneul', 'ayanesena', 'sunza1122', 'k1baaa', 'bxroong', 'isq1158', 'mini1212', 'ddikku0714', 'kakazzang'],
    nicknames: ['장지수', '냥냥두둥', '치치', '시몽', '유오늘', '아야네세나', '포포', '채니', '코로미', '구월이', '린링', '띠꾸', '후룽카카'],
  },
  {
    key: 'musu',
    label: '무수',
