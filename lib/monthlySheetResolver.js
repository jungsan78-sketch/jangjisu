...
const EXACT_MONTHLY_GIDS = {
  '1J0H1eHRB05ojAW3kqHrQBoMU68DjJV4SgRViwszyZBs:2026-08': '1765161556',
  '1qu7DXG99c9WbR5g-t1HL2BU_bFlqhxwN45tscolZ_U0:2026-08': '730341520',
...
export async function fetchMonthlySheet(sheetId, monthInfo, pattern) {
  ...
  for (const sheetName of candidates) {
    try {
      ...
      const result = gid
        ? await fetchRowsByGid(sheetId, gid)
        : await fetchRowsBySheetName(sheetId, sheetName);
      return {
        ...result,
        sheetName,
        gid,
